...
export default async function ManagerVisualPagesList({
  searchParams,
}: {
              ...
              {pages.map((page) => (
                <div key={page.key} className="rounded-xl border border-gray-200 p-4">
                  ...
                  <div className="mt-4 flex gap-2">
                    <Link
                      href={`/managers/pages/visual/${page.key}`}
                      className="rounded-lg bg-[#4CAF50] px-3 py-2 text-xs font-medium text-white hover:bg-[#43A047]"
                    >
                      Редактировать
                    </Link>
                    <Link
