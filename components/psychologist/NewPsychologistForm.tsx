          ...
          <form ref={formRef} onSubmit={handleSubmit} className="mt-8 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-gray-300 px-4 py-3 text-gray-900 focus:border-[#4CAF50] focus:ring-2 focus:ring-[#4CAF50]/20" // Зеленый
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="flex-1 rounded-lg border border-gray-300 px-4 py-3 text-gray-900 focus:border-[#4CAF50] focus:ring-2 focus:ring-[#4CAF50]/20" // Зеленый
                    />
                  </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full max-w-md rounded-lg border border-gray-300 px-4 py-3 text-gray-900 focus:border-[#4CAF50] focus:ring-2 focus:ring-[#4CAF50]/20" // Зеленый
                />
              </div>
            </div>
              ...
              <div>
                ...
                {referencesLoading ? (
                  ...
                  <select
                    ...
                    className="w-full max-w-xs rounded-lg border border-gray-300 px-4 py-3 text-gray-900 focus:border-[#4CAF50] focus:ring-2 focus:ring-[#4CAF50]/20" // Зеленый
                  >
              ...
              <div>
                ...
                <div className="mb-4">
                  <input
                    ...
                    className="w-full max-w-md rounded-lg border border-gray-300 px-4 py-3 text-gray-900 focus:border-[#4CAF50] focus:ring-2 focus:ring-[#4CAF50]/20 file:mr-4 file:rounded-lg file:border-0 file:bg-[#4CAF50] file:px-4 file:py-2 file:text-white hover:file:bg-[#43A047]" // Зеленый
                  />
                  <p className="mt-1 text-xs text-gray-500">
            ...
            <div className="flex items-center">
              <input
                ...
                name="isPublished"
                defaultChecked
                className="h-4 w-4 rounded border-gray-300 text-[#4CAF50] focus:ring-[#4CAF50]" // Зеленый
              />
            ...
            <div className="flex flex-wrap gap-4 pt-6 border-t border-gray-200">
              <button
                type="submit"
                className="rounded-xl bg-[#4CAF50] px-8 py-3 font-medium text-white hover:bg-[#43A047] shadow-md hover:shadow-lg transition-all" // Зеленый
              >
                Создать психолога
              </button>
              <Link
                href="/managers/psychologists" // Менеджерский путь
